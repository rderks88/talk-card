...
(function () {
  ...
  var I18N = {
    nl: {
      ...
      tribute: "Geïnspireerd door mijn oom Will",
      ...
      steps: {
        ...
        born: { title: "GEBOREN", q: "Waar en in wat voor gezin is hij/zij geboren?", hint: "Geboorteplaats, het gezin, de achtergrond.", placeholder: "…in Sneek, in Friesland. De oudste dochter van een boerengezin met vijf kinderen." },
        ...
        important: { title: "WAT IK BELANGRIJK VIND", q: "Wat vindt hij/zij belangrijk?", hint: "Waar iemand zich prettig bij voelt.", placeholder: "Bijv. een rustige omgeving, een vaste dagindeling en een kopje thee om vier uur" },
        annoying: { title: "VERVELEND IS", q: "Wat vindt hij/zij juist vervelend?", hint: "Dingen om te vermijden, zodat een gesprek prettig blijft.", placeholder: "Bijv. harde geluiden, gehaast worden en te veel mensen tegelijk" },
        work: { title: "WERK", q: "Wat voor werk heeft hij/zij gedaan?", hint: "Beroep(en) en loopbaan.", placeholder: "Bijv. naaister, en later hulp in de huishouding" },
        education: { title: "OPLEIDINGEN", q: "Welke opleidingen of scholen?", hint: "Studies en opleidingen.", placeholder: "Bijv. de huishoudschool in Sneek" },
        living: { title: "WONEN", q: "Waar woont hij/zij?", hint: "Adres of plaats.", placeholder: "Bijv. Kerkstraat 12, Sneek" }
      }
    },
    ...
    en: {
      ...
      tribute: "Inspired by my uncle Will",
      ...
      steps: {
        name: { q: "Who is this card for?", hint: "The name of your loved one. It appears large next to the photo.", placeholder: "e.g. Arthur", example: "Arthur" },
        ...
        born: { title: "BORN", q: "Where and into what kind of family were they born?", hint: "Place of birth, the family, the background.", placeholder: "…in Leeds, in Yorkshire. The youngest of four boys in a working-class family." },
        partner: { title: "PARTNER", q: "Who is the partner?", hint: "The name of the partner or loved one.", placeholder: "e.g. Dorothy" },
        children: { title: "CHILDREN", q: "What are the children's names?", hint: "The names of the children.", placeholder: "e.g. Susan, David and Karen" },
        siblings: { title: "SIBLINGS", q: "Brothers and sisters?", hint: "Names of brothers and sisters.", placeholder: "e.g. Harold, Frank and Edith" },
        visitors: { title: "VISITORS", q: "Who comes to visit?", hint: "Family and friends who drop by — helpful to be able to name them.", placeholder: "e.g. Dorothy, the neighbours Ron and Betty, and old friends from the bowls club" },
        enjoys: { title: "I ENJOY…", q: "What do they enjoy?", hint: "Things that bring calm, joy or a smile.", placeholder: "e.g. a cup of tea in the garden, brass band music and doing the crossword" },
        hobbies: { title: "HOBBIES", q: "What are the hobbies?", hint: "Activities and interests.", placeholder: "e.g. gardening, woodworking and watching the cricket" },
        highlights: { title: "HIGHLIGHTS", q: "What are the highlights of their life?", hint: "Lovely moments, proud moments, special events.", placeholder: "e.g. marrying Dorothy, building the family home and the trip to Scotland" },
        important: { title: "WHAT MATTERS TO ME", q: "What is important to them?", hint: "What helps someone feel at ease.", placeholder: "e.g. a calm room, a steady routine and a cup of tea at four o'clock" },
        annoying: { title: "WHAT I DISLIKE", q: "What do they find unpleasant?", hint: "Things to avoid, to keep a conversation pleasant.", placeholder: "e.g. loud noises, being rushed and too many people at once" },
        work: { title: "WORK", q: "What work did they do?", hint: "Profession(s) and career.", placeholder: "e.g. joiner, and later foreman at the local factory" },
        education: { title: "EDUCATION", q: "Which studies or schools?", hint: "Studies and education.", placeholder: "e.g. the grammar school in Leeds, then an apprenticeship" },
        living: { title: "LIVES AT", q: "Where do they live?", hint: "Address or town.", placeholder: "e.g. 14 Mill Lane, Leeds" }
      }
    },
    ...
    de: {
      ...
      tribute: "Inspiriert von meinem Onkel Will",
      ...
      steps: {
        name: { q: "Für wen ist diese Karte?", hint: "Der Name Ihres lieben Menschen. Er erscheint groß neben dem Foto.", placeholder: "z. B. Werner", example: "Werner" },
        ...
        born: { title: "GEBOREN", q: "Wo und in welcher Familie wurde er/sie geboren?", hint: "Geburtsort, Familie, Herkunft.", placeholder: "…in Regensburg, in Bayern. Der jüngste Sohn einer Handwerkerfamilie mit sechs Kindern." },
        partner: { title: "PARTNER", q: "Wer ist der Partner / die Partnerin?", hint: "Der Name des Partners oder der geliebten Person.", placeholder: "z. B. Ingrid" },
        children: { title: "KINDER", q: "Wie heißen die Kinder?", hint: "Die Namen der Kinder.", placeholder: "z. B. Sabine, Thomas und Petra" },
        siblings: { title: "GESCHWISTER", q: "Brüder und Schwestern?", hint: "Namen der Geschwister.", placeholder: "z. B. Helmut, Ursula und Klaus" },
        visitors: { title: "BESUCHER", q: "Wer kommt zu Besuch?", hint: "Familie und Freunde, die vorbeikommen — schön, sie beim Namen zu nennen.", placeholder: "z. B. Ingrid, die Nachbarn Hans und Erika, und alte Freunde vom Kegelverein" },
        enjoys: { title: "ICH GENIESSE…", q: "Was genießt er/sie?", hint: "Dinge, die Ruhe, Freude oder ein Lächeln schenken.", placeholder: "z. B. nachmittags Kaffee und Kuchen, Blasmusik und Spaziergänge" },
        hobbies: { title: "HOBBYS", q: "Was sind die Hobbys?", hint: "Beschäftigungen und Interessen.", placeholder: "z. B. Gartenarbeit, Wandern und Kartenspielen" },
        highlights: { title: "HÖHEPUNKTE", q: "Was sind die Höhepunkte im Leben?", hint: "Schöne Momente, stolze Momente, besondere Ereignisse.", placeholder: "z. B. die Hochzeit mit Ingrid, der Bau des Eigenheims und die Reise nach Italien" },
        important: { title: "WAS MIR WICHTIG IST", q: "Was ist ihm/ihr wichtig?", hint: "Was jemandem ein gutes Gefühl gibt.", placeholder: "z. B. eine ruhige Umgebung, ein fester Tagesablauf und Kaffee um vier Uhr" },
        annoying: { title: "WAS MICH STÖRT", q: "Was findet er/sie unangenehm?", hint: "Dinge, die man vermeiden sollte, damit ein Gespräch angenehm bleibt.", placeholder: "z. B. laute Geräusche, Hektik und zu viele Menschen auf einmal" },
        work: { title: "ARBEIT", q: "Welchen Beruf hatte er/sie?", hint: "Beruf(e) und Werdegang.", placeholder: "z. B. Schreiner, später Meister in einer Möbelfabrik" },
        education: { title: "AUSBILDUNG", q: "Welche Ausbildungen oder Schulen?", hint: "Studium und Ausbildung.", placeholder: "z. B. die Volksschule in Regensburg, danach eine Lehre" },
        living: { title: "WOHNORT", q: "Wo wohnt er/sie?", hint: "Adresse oder Ort.", placeholder: "z. B. Gartenstraße 8, Regensburg" }
      }
    },
    ...
    fr: {
      ...
      tribute: "Inspiré par mon oncle Will",
      ...
      steps: {
        name: { q: "Pour qui créez-vous cette carte ?", hint: "Le nom de votre proche. Il apparaît en grand à côté de la photo.", placeholder: "p. ex. Colette", example: "Colette" },
        ...
        born: { title: "NAISSANCE", q: "Où et dans quelle famille est-il/elle né(e) ?", hint: "Lieu de naissance, la famille, les origines.", placeholder: "…à Quimper, en Bretagne. L'aînée d'une famille de pêcheurs de cinq enfants." },
        partner: { title: "PARTENAIRE", q: "Qui est le/la partenaire ?", hint: "Le nom du/de la partenaire ou de l'être cher.", placeholder: "p. ex. Marcel" },
        children: { title: "ENFANTS", q: "Comment s'appellent les enfants ?", hint: "Les prénoms des enfants.", placeholder: "p. ex. Sylvie, Jean-Paul et Nathalie" },
        siblings: { title: "FRÈRES & SŒURS", q: "Frères et sœurs ?", hint: "Prénoms des frères et sœurs.", placeholder: "p. ex. Yvonne, Robert et Madeleine" },
        visitors: { title: "VISITEURS", q: "Qui vient lui rendre visite ?", hint: "La famille et les amis qui passent — utile de pouvoir les nommer.", placeholder: "p. ex. Marcel, les voisins Bernard et Monique, et les amies du club de tricot" },
        enjoys: { title: "J'AIME…", q: "Qu'est-ce qu'il/elle aime ?", hint: "Ce qui apporte du calme, de la joie ou un sourire.", placeholder: "p. ex. un café le matin, les chansons d'autrefois et s'asseoir au jardin" },
        hobbies: { title: "LOISIRS", q: "Quels sont les loisirs ?", hint: "Activités et centres d'intérêt.", placeholder: "p. ex. le tricot, les mots croisés et le jardinage" },
        highlights: { title: "MOMENTS FORTS", q: "Quels sont les moments forts de sa vie ?", hint: "Beaux moments, fiertés, événements particuliers.", placeholder: "p. ex. son mariage avec Marcel, la naissance des enfants et le voyage à Lourdes" },
        important: { title: "CE QUI COMPTE POUR MOI", q: "Qu'est-ce qui est important pour lui/elle ?", hint: "Ce qui aide à se sentir à l'aise.", placeholder: "p. ex. un environnement calme, des horaires réguliers et un café à quatre heures" },
        annoying: { title: "CE QUI ME DÉRANGE", q: "Qu'est-ce qu'il/elle trouve désagréable ?", hint: "Les choses à éviter, pour que la conversation reste agréable.", placeholder: "p. ex. les bruits forts, la précipitation et trop de monde à la fois" },
        work: { title: "TRAVAIL", q: "Quel métier a-t-il/elle exercé ?", hint: "Profession(s) et parcours.", placeholder: "p. ex. couturière, puis aide à domicile" },
  ...
  /* =========================================================
     ...
     ========================================================= */
  var EXAMPLES = [
    { lang: "nl", name: "Cornelis", date: "12 maart 1948", photo: "example-1.jpg", bubbles: [
